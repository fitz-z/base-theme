...
const Footer = (props) => {
  return (
    <div className="w-full flex justify-center items-center bg-white p-5 border-t border-primary-dark">
      <div className="max-w-screen-xl w-full justify-between items-center flex text-primary">
        <div className="flex">
          <Link href="/">
